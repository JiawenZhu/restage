      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-8 pt-14 sm:px-10 sm:pt-20">
        <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,540px)_minmax(0,1fr)]">
          ...
          <div className="flex items-center gap-5">
            ...
            {/*
              The actual output, playing.

              This was a still with a play badge drawn on top of it — a picture
              of a video, on the page arguing that the videos do not look
              generated. The weakest possible evidence for the one claim the
              product has to make, and it invited the obvious question of why
              there was no video.

              public/hero-ad.mp4 is made by scripts/make-hero-ad.mts, which runs
              the real pipeline: the same planner, the same frame generation from
              the enrolment angles beside it, the same Veo render and stitch a
              user's own run goes through. The three thumbnails to the left are
              that avatar's actual enrolment captures, so "these photographs
              became this person" is something a visitor can check by looking
              rather than something the page asserts.
            */}
            <div className="relative min-w-0 flex-1">
              <div className="overflow-hidden rounded-[18px] shadow-[0_30px_70px_-28px_rgba(0,0,0,0.55)]">
                <video
                  src="/hero-ad.mp4"
                  poster="/hero-poster.jpg"
                  /* Muted is not a preference, it is the price of autoplay —
                     every browser blocks sound without a gesture. The clips do
                     carry audio; the control below turns it on. */
                  autoPlay
                  muted
                  loop
                  playsInline
                  preload="metadata"
                  aria-label="A finished vertical ad, generated by Restage from the three enrolment photos shown"
                  className="h-[420px] w-full bg-black object-cover sm:h-[512px]"
                />
              </div>
              <div className="absolute left-4 top-4 flex gap-2">
                <span className="rounded-[5px] bg-black/70 px-2.5 py-1 text-[10px] font-bold tracking-[0.08em] text-white">9:16</span>
                <span className="rounded-[5px] bg-black/70 px-2.5 py-1 text-[10px] font-bold tracking-[0.08em] text-white">1080p</span>
              </div>
              {/*
