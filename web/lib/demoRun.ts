...
export const demoNodes: TreeNode[] = [
  { id: 'root', parentId: null, stepNo: 0, kind: 'avatar', status: 'achieved', frameUrl: '/img/persona-front.jpg', createdAt: t(1) },
  {
    id: 'n1', label: 'Kitchen scene', parentId: 'root', stepNo: 1, kind: 'frame', status: 'achieved', frameUrl: '/img/shot-1.jpg',
  ...
  {
    id: 'n2', label: "Arm's-length framing", parentId: 'n1', stepNo: 2, kind: 'frame', status: 'achieved', frameUrl: '/img/shot-2.jpg',
  ...
  {
    id: 'n3x', label: 'Window light', parentId: 'n2', stepNo: 3, kind: 'frame', status: 'failed', frameUrl: '/img/shot-rejected.jpg',
    discarded: true,
  ...
  {
    id: 'n3', label: 'Window light', parentId: 'n2', stepNo: 3, kind: 'frame', status: 'partial', frameUrl: '/img/shot-3.jpg',
    instruction: 'Light it from the window',
  ...
  {
    id: 'n4', label: 'Product to lens', parentId: 'n3', stepNo: 4, kind: 'frame', status: 'generating', frameUrl: '/img/shot-4.jpg',
